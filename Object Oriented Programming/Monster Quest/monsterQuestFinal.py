...
class Game:
    def __init__(self, player_health):
        ...
        enemy1 = Enemy("Lilly", "I'm not posh, I'm comfortable!!!", "41", "I'm going to crashout!!",
    ...
    def play_game(self):
        self.opponent = random.choice(self.monsters)
        while self.player_health > 0 and self.opponent.health > 0:
